export default function Home() {
  return (
    <div className="container mx-auto">
      ...
      <div className="h-[calc(100vh-65px-57px)] overflow-auto">
        <div>
      ...
      <div>
        ...
        <div className="h-[400px] border flex items-center justify-center mb-2">
          hero
        </div>
        <div className="flex gap-2 basis-6/12 mb-2">
          <div className="h-[100px] border rounded flex-1"></div>
          <div className="h-[100px] border rounded flex-1"></div>
        </div>

      </div>
      <div className="text-center py-4 border-t">footer</div>
    </div>
  );
}
